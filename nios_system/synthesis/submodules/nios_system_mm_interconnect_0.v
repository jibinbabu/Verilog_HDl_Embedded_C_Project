...
module nios_system_mm_interconnect_0 (
	...
	wire  [109:0] rsp_mux_001_src_data;                                                         // rsp_mux_001:src_data -> sgdma_tx_descriptor_read_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                        // sgdma_tx_descriptor_read_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [8:0] rsp_mux_001_src_channel;                                                      // rsp_mux_001:src_channel -> sgdma_tx_descriptor_read_agent:rp_channel
	...
	wire  [109:0] rsp_mux_002_src_data;                                                         // rsp_mux_002:src_data -> sgdma_rx_descriptor_read_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                        // sgdma_rx_descriptor_read_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [8:0] rsp_mux_002_src_channel;                                                      // rsp_mux_002:src_channel -> sgdma_rx_descriptor_read_agent:rp_channel
	...
	wire  [109:0] rsp_mux_003_src_data;                                                         // rsp_mux_003:src_data -> sgdma_tx_descriptor_write_agent:rp_data
	wire          rsp_mux_003_src_ready;                                                        // sgdma_tx_descriptor_write_agent:rp_ready -> rsp_mux_003:src_ready
	wire    [8:0] rsp_mux_003_src_channel;                                                      // rsp_mux_003:src_channel -> sgdma_tx_descriptor_write_agent:rp_channel
	...
	wire  [109:0] rsp_mux_004_src_data;                                                         // rsp_mux_004:src_data -> sgdma_rx_descriptor_write_agent:rp_data
	wire          rsp_mux_004_src_ready;                                                        // sgdma_rx_descriptor_write_agent:rp_ready -> rsp_mux_004:src_ready
	wire    [8:0] rsp_mux_004_src_channel;                                                      // rsp_mux_004:src_channel -> sgdma_rx_descriptor_write_agent:rp_channel
	...
	wire    [8:0] rsp_mux_006_src_channel;                                                      // rsp_mux_006:src_channel -> sgdma_tx_m_read_agent:rp_channel
	...
	wire    [8:0] rsp_mux_007_src_channel;                                                      // rsp_mux_007:src_channel -> sgdma_rx_m_write_agent:rp_channel
	...
	wire    [8:0] cmd_mux_001_src_channel;                                                      // cmd_mux_001:src_channel -> tse_control_port_agent:cp_channel
	...
	wire    [8:0] cmd_mux_003_src_channel;                                                      // cmd_mux_003:src_channel -> sgdma_tx_csr_agent:cp_channel
	...
	wire    [8:0] cmd_mux_005_src_channel;                                                      // cmd_mux_005:src_channel -> main_memory_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_007_src_channel;                                                      // cmd_mux_007:src_channel -> led_s1_agent:cp_channel
	...
	wire  [109:0] sgdma_tx_descriptor_read_agent_cp_data;                                       // sgdma_tx_descriptor_read_agent:cp_data -> router_001:sink_data
	...
	wire  [109:0] sgdma_rx_descriptor_read_agent_cp_data;                                       // sgdma_rx_descriptor_read_agent:cp_data -> router_002:sink_data
	...
	wire  [109:0] sgdma_tx_descriptor_write_agent_cp_data;                                      // sgdma_tx_descriptor_write_agent:cp_data -> router_003:sink_data
	...
	wire  [109:0] sgdma_rx_descriptor_write_agent_cp_data;                                      // sgdma_rx_descriptor_write_agent:cp_data -> router_004:sink_data
	...
	wire    [8:0] router_005_src_channel;                                                       // router_005:src_channel -> nios2_instruction_master_limiter:cmd_sink_channel
	...
	wire    [8:0] nios2_instruction_master_limiter_cmd_src_channel;                             // nios2_instruction_master_limiter:cmd_src_channel -> cmd_demux_005:sink_channel
	...
	wire    [8:0] rsp_mux_005_src_channel;                                                      // rsp_mux_005:src_channel -> nios2_instruction_master_limiter:rsp_sink_channel
	...
	wire    [8:0] cmd_demux_001_src0_channel;                                                   // cmd_demux_001:src0_channel -> cmd_mux_006:sink1_channel
	...
	wire    [8:0] cmd_demux_002_src0_channel;                                                   // cmd_demux_002:src0_channel -> cmd_mux_006:sink2_channel
	...
	wire    [8:0] cmd_demux_003_src0_channel;                                                   // cmd_demux_003:src0_channel -> cmd_mux_006:sink3_channel
	...
	wire    [8:0] cmd_demux_004_src0_channel;                                                   // cmd_demux_004:src0_channel -> cmd_mux_006:sink4_channel
	...
	wire    [8:0] cmd_demux_005_src0_channel;                                                   // cmd_demux_005:src0_channel -> cmd_mux_004:sink1_channel
	...
	wire    [8:0] cmd_demux_005_src1_channel;                                                   // cmd_demux_005:src1_channel -> cmd_mux_005:sink1_channel
	...
	wire    [8:0] cmd_demux_006_src0_channel;                                                   // cmd_demux_006:src0_channel -> cmd_mux_005:sink2_channel
	...
	wire    [8:0] cmd_demux_007_src0_channel;                                                   // cmd_demux_007:src0_channel -> cmd_mux_005:sink3_channel
	...
	wire    [8:0] rsp_demux_004_src1_channel;                                                   // rsp_demux_004:src1_channel -> rsp_mux_005:sink0_channel
	...
	wire    [8:0] rsp_demux_005_src1_channel;                                                   // rsp_demux_005:src1_channel -> rsp_mux_005:sink1_channel
	...
	wire    [8:0] rsp_demux_005_src2_channel;                                                   // rsp_demux_005:src2_channel -> rsp_mux_006:sink0_channel
	...
	wire    [8:0] rsp_demux_005_src3_channel;                                                   // rsp_demux_005:src3_channel -> rsp_mux_007:sink0_channel
	...
	wire    [8:0] rsp_demux_006_src1_channel;                                                   // rsp_demux_006:src1_channel -> rsp_mux_001:sink0_channel
	...
	wire    [8:0] rsp_demux_006_src2_channel;                                                   // rsp_demux_006:src2_channel -> rsp_mux_002:sink0_channel
	...
	wire    [8:0] rsp_demux_006_src3_channel;                                                   // rsp_demux_006:src3_channel -> rsp_mux_003:sink0_channel
	...
	wire    [8:0] rsp_demux_006_src4_channel;                                                   // rsp_demux_006:src4_channel -> rsp_mux_004:sink0_channel
	...
	wire    [8:0] nios2_instruction_master_limiter_cmd_valid_data;                              // nios2_instruction_master_limiter:cmd_src_valid -> cmd_demux_005:sink_valid
	...
	nios_system_mm_interconnect_0_router_008 router_015 (
	...
	nios_system_mm_interconnect_0_router_008 router_016 (
